...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCallkitVoip/CapacitorCallkitVoip.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FreshaCapacitorPluginApplepay/FreshaCapacitorPluginApplepay.framework"
